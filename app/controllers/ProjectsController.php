...
class ProjectsController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				projects.review_progress LIKE ? OR 
				projects.feedback LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("project_name","admission_number","supervisor","project_file","submission_status");
			...
			$this->sanitize_array = array(
				...
				'project_file' => 'sanitize_string',
				'submission_status' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","project_name","admission_number","supervisor","expected_date","project_file","submission_status");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'project_name' => 'required',
