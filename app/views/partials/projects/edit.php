                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-project_name"  value="<?php  echo $data['project_name']; ?>" type="text" placeholder="Enter Project Name"  required="" name="project_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <div class="dropzone " input="#ctrl-project_file" fieldname="project_file"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                            <input name="project_file" id="ctrl-project_file" class="dropzone-input form-control" value="<?php  echo $data['project_file']; ?>" type="text"  />
                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                            </div>
                                                        </div>
                                                        <?php Html :: uploaded_files_list($data['project_file'], '#ctrl-project_file'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-submission_status" name="submission_status"  placeholder="Specify status ..."    class="custom-select" >
                                                                ...
                                                                $field_value = $data['submission_status'];
